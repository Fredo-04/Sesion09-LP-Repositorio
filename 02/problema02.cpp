...
return "Error, fuera de rango.";//sobreescribimos el .what() de la clase "heredad" exception.  
}  
};  
...
class EstructuraDeDatos{  
    ...
    int tamanio;  
    public:  
    EstructuraDeDatos(char tam):tamanio(tam){}  
    void operator [](int indice){//metodo para la excepcion.  
...
{  
        ...
        cin>>opcion;  
        MiEstructura[opcion];//como la estructura es de tamanio 5, nos lanzara la excepcion  
...
//Las clases de excepciones nos permiten crear excepciones personalizadas para las clases al sobrescribir el .what()  